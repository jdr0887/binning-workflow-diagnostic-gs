package org.renci.canvas.binning.diagnostic.gs.commands;
...
import org.renci.canvas.binning.diagnostic.gs.commons.UpdateDiagnosticBinsCallable;
...
@Command(scope = "diagnostic-gs", name = "update-diagnostic-bins", description = "Update Diagnostic Bins")
@Service
