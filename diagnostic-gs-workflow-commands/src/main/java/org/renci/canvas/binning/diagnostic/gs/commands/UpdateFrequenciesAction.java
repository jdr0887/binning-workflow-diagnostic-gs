...
import org.renci.canvas.binning.diagnostic.gs.commons.UpdateFrequenciesCallable;
...
@Command(scope = "diagnostic-gs", name = "update-frequencies", description = "Update Frequencies")
@Service
