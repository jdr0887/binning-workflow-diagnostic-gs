...
import org.renci.canvas.binning.diagnostic.gs.commons.GenerateReportCallable;
...
@Command(scope = "diagnostic-gs", name = "generate-report", description = "Generate Report")
@Service
